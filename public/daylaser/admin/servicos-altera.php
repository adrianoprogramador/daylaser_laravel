    ...
    <div class="container">
          ...
          <div class="jumbotron">
            ...
            <fieldset class="col-lg-12">
                <form action="altera-servicos.php" method="POST"  class="col-md-12 col-xl-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="detalhe" name="detalhe" rows="3"
                        placeholder="Digite o texto"><?=$serv['detalhe']?></textarea>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="form-group">
                          ...
                          value="<?=$serv['valor']?>" placeholder="Digite o titulo">                         
                        </div>
                         
                        <div class="form-group">
                        <label>Mostrar precos</label>
                            <select name="pacote" class="form-control">                                                                               
                                <option value="1" <?=$serv['pacote'] == '1' ? 'selected' : ''?>>Sim</option>
                                <option value="0" <?=$serv['pacote'] != '1' ? 'selected' : ''?>>Não</option>
                            </select>  
