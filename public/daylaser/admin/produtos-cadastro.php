...
<!------formulario------------------>
    <div class="container">
          ...
          <div class="jumbotron">
            <span class="caminho"><h1>Dashboard &raquo; Cadastar Produtos</h1></span>
          </div>
          
          

            <fieldset class="col-lg-12">
                <form action="adiciona-produtos.php" method="POST" class="col-md-12 col-xl-12" >
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="descricao" name="descricao" rows="2" placeholder="Descrição do produto"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="preco" name="preco" placeholder="Digite o Preço">
                    </div>                     
